...
Be careful about SQL injection in query parameters, as I was able to pass unescaped additional clauses into a single parameter as shown:

<img src="{{ site.url }}/img/posts/data_viz_sql_injection.png" class="img-responsive" style="border: 1px solid gray; padding:10px"/>
